...
\begin{figure}
    \centering
    \subfloat[]{
    \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/adaloss_small_vs_const_large.png}
	\label{fig:sieve_small_vs_const_large}    
    }
    ~
    \subfloat[]{
    \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/ann.png}
    \label{fig:ann}
    }
...
\begin{figure}
    \centering
    \subfloat[]{
        \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/loss_cifar100.png}
        \label{fig:loss_cifar100}
    }
    ~
    \subfloat[]{
	    \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/EANN.png} \label{fig:eann}
	}
...
\begin{figure}[h]
    ...
    \subfloat[Res\anns on CIFAR10]{
        \includegraphics[width=0.44\linewidth, keepaspectratio ]{\ANNDIR/adaloss_vs_const_of_double_cost_cifar10.png}
        \label{fig:adaloss_vs_const_of_double_cost_cifar10}
    }
    ~
    \subfloat[Res\anns on CIFAR100]{
        \includegraphics[width=0.44\linewidth, keepaspectratio ]{\ANNDIR/adaloss_vs_const_of_double_cost_cifar100.png}
...
\begin{figure}[h]
    ...
    \subfloat[Res\anns on SVHN]{
        \includegraphics[width=0.44\linewidth, keepaspectratio ]{\ANNDIR/adaloss_vs_const_of_double_cost_svhn.png}
...
\begin{figure}[h]
    ...
    \subfloat[Res\anns on ILSVRC]{
        \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/ilsvrc_adaloss_vs_const_resnet.png}
        \label{fig:ilsvrc_adaloss_vs_const_of_double_cost}
    }
    ~
    \subfloat[MSDNet on ILSVRC]{
        \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/ilsvrc_adaloss_vs_const_msdnet.png}
...
\centering
    ...
    \subfloat[\anns comparison on ILSVRC]{
        \includegraphics[width=0.6\linewidth, keepaspectratio]{\ANNDIR/ilsvrc_compare_models.png}
...
\begin{figure}[t]
    ...
    \subfloat[EANNs on CIFAR100]{
        \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/cifar100_adaloss_eann_b2.png}
        \label{fig:eann_f}
    }
    ~
    \subfloat[EANN on ILSVRC]{
        \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/eann_comparisons.png}
        \label{fig:compare_ensemble}
    }
    
    \subfloat[AdaLoss Weights on three data-sets]{
    \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/adaloss_weights.png}
