...
\section{ENSEMBLE of EXPONENTIALLY DEEPENING ANYTIME NEURAL NETWORKS}
\label{sec:eann}
...
\begin{figure*}[ht!]
    ...
    \subfloat[\anns comparison on ILSVRC]{
        \includegraphics[width=0.44\linewidth, keepaspectratio]{\ANNDIR/ilsvrc_compare_models.png}
...
\section{PROOF of PROPOSITION~\ref{prop:eann}}
\begin{proof}
...
\section{IMPLEMENTATION DETAILS of \adaloss}
